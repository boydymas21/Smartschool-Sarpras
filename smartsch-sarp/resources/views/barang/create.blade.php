...
<form action="{{url('barang')}}" method="POST">
    ...
    <div class="card-body">
        ...
        <div class="form-group">
            ...
            <input name="satuan" type="text" class="form-control" placeholder="">
        </div>
        <div class="form-group">
            <label>Kategori Barang</label>
            <input name="kategori" type="text" class="form-control" placeholder="">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label>Foto</label>
            <input name="imgs" type="text" class="form-control" placeholder="">
        </div>
